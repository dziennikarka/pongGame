...
wn = turtle.Screen()
wn.title("Pong by Irina Tregub")
wn.bgcolor("black")
wn.setup(width=800, height=600)
wn.tracer(0) #prevents automatic updating of window
...
paddle_a.speed(0) #sets the speed to the maximum possible
...
paddle_b.speed(0) #sets the speed to the maximum possible
...
#Ball
ball = turtle.Turtle()
ball.speed(0) #sets the speed to the maximum possible
ball.shape("square")
ball.color("white")
ball.penup()
ball.goto(0,0)
